            ...
            <div class="vo-card__body">
              ...
              <div v-if="!sameAsOfficialResidential" class="vo-grid vo-grid--4 vo-mt">
                <div class="vo-field-wrap">
                  ...
                  <div class="vo-input-box" :class="{ 'vo-input-box--disabled': disableVendorInput }">
                    <span class="mdi mdi-home-outline vo-input-icon"></span>
                    <input v-model.trim="form.residential_address" :disabled="disableVendorInput" class="vo-input" placeholder="Residential door no." />
                  </div>
                </div>
                <div class="vo-field-wrap">
                  <label class="vo-label">STREET LINE 1</label>
                  <div class="vo-input-box" :class="{ 'vo-input-box--disabled': disableVendorInput }">
                    <span class="mdi mdi-road-variant vo-input-icon"></span>
                    <input v-model.trim="form.res_address1" :disabled="disableVendorInput" class="vo-input" placeholder="Street address 1" />
                  </div>
                </div>
                <div class="vo-field-wrap">
                  <label class="vo-label">STREET LINE 2</label>
                  <div class="vo-input-box" :class="{ 'vo-input-box--disabled': disableVendorInput }">
                    <span class="mdi mdi-road-variant vo-input-icon"></span>
                    <input v-model.trim="form.res_address2" :disabled="disableVendorInput" class="vo-input" placeholder="Street address 2" />
                  </div>
                </div>
                <div class="vo-field-wrap" :class="{ 'vo-input-box--disabled': disableVendorInput }">
                  <label class="vo-label">LANDMARK</label>
                  <div class="vo-input-box">
                    <span class="mdi mdi-sign-direction vo-input-icon"></span>
                    <input v-model.trim="form.res_address3" :disabled="disableVendorInput" class="vo-input" placeholder="Landmark (optional)" />
                  </div>
                </div>
                <div class="vo-field-wrap vo-pincode-wrap">
                  <label class="vo-label">SEARCH PINCODE</label>
              ...
              <div v-if="!sameAsOfficialVisitor" class="vo-grid vo-grid--4 vo-mt">
                <div class="vo-field-wrap">
                  ...
                  <div class="vo-input-box" :class="{ 'vo-input-box--disabled': disableVendorInput }">
                    ...
                    <input v-model.trim="form.vister_address" :disabled="disableVendorInput" class="vo-input" placeholder="Visitor/shop door no." />
                  </div>
                </div>
                <div class="vo-field-wrap" >
                  <label class="vo-label">STREET LINE 1</label>
                  <div class="vo-input-box" :class="{ 'vo-input-box--disabled': disableVendorInput }">
                    <span class="mdi mdi-road-variant vo-input-icon"></span>
                    <input v-model.trim="form.v_address1" :disabled="disableVendorInput" class="vo-input" placeholder="Street address 1" />
                  </div>
                </div>
                <div class="vo-field-wrap">
                  <label class="vo-label">STREET LINE 2</label>
                  <div class="vo-input-box" :class="{ 'vo-input-box--disabled': disableVendorInput }">
                    <span class="mdi mdi-road-variant vo-input-icon"></span>
                    <input v-model.trim="form.v_address2" :disabled="disableVendorInput" class="vo-input" placeholder="Street address 2" />
                  </div>
                </div>
                <div class="vo-field-wrap">
                  <label class="vo-label">LANDMARK</label>
                  <div class="vo-input-box" :class="{ 'vo-input-box--disabled': disableVendorInput }">
                    <span class="mdi mdi-sign-direction vo-input-icon"></span>
                    <input v-model.trim="form.v_address3" :disabled="disableVendorInput" class="vo-input" placeholder="Landmark (optional)" />
                  </div>
                </div>
                <div class="vo-field-wrap vo-pincode-wrap">
                  <label class="vo-label">SEARCH PINCODE</label>
            ...
            <div class="vo-card__body">
              ...
              <div v-if="docStep === 1">
                ...
                <div class="vo-doctype-grid">
                  <div v-for="doc in activeCategory?.documents" :key="doc.code"
                    ...
                    :class="doc.uploaded ? 'vo-doctype-card--done' : 'vo-doctype-card--pending'">
                    <span class="mdi vo-doctype-card__icon" :class="doc.uploaded ? 'mdi-check-circle-outline' : 'mdi-alert-circle-outline'"></span>
                    <p class="vo-doctype-card__name">{{ doc.name }}</p>
                    <span class="vo-doctype-card__status" :class="doc.uploaded ? 'vo-doctype-card__status--done' : 'vo-doctype-card__status--pending'">
              ...
              <div v-if="docStep === 2">
                ...
                <div class="vo-upload-card vo-mt">
                  ...
                  <button class="vo-save-btn" :disabled="!docUploads[activeDocType]?.files?.length" @click="saveDocUpload">
...
async function submit() {
  ...
  try {
    ...
    if (res?.data?.statusCode === "00") router.push("/aggregator/onboarding/success");
...
onMounted(async () => {
  console.log("vendor ID from props:", props.vendorId);
  if (props.vendorId) {
