        ...
        <div class="main-card">
            ...
            <div class="card-body step1-body">
              ...
              <template v-else-if="merchantProfile">
                ...
                <p class="verify-instruction">
                  ...
                  Clicking <strong>Confirm &amp; Send OTP</strong> will send a verification code to the registered mobile number
                ...
                <div class="detail-section">
                  ...
                  <div class="detail-grid">
                    <div class="detail-item"><span class="di-key">Legal Name</span><span class="di-val">{{ merchantProfile.legal_name || '—' }}</span></div>
                    ...
                    <div class="detail-item"><span class="di-key">MCC</span><span class="di-val">{{ merchantProfile.mcc || '—' }}</span></div>
                    <div class="detail-item"><span class="di-key">Annual Turnover</span><span class="di-val">{{ merchantProfile.annual_turn_over || '—' }}</span></div>
                    <div class="detail-item"><span class="di-key">Date of Birth</span><span class="di-val">{{ merchantProfile.dob || merchantProfile.business_dob || '—' }}</span></div>
                ...
                <div class="detail-section">
                  ...
                  <div class="detail-grid">
                    ...
                    <div class="detail-item otp-highlight-cell">
                      <span class="di-key">Primary Mobile <span class="otp-will-use-tag">OTP will be sent here</span></span>
                      <span class="di-val">{{ merchantProfile.primary_mobile || merchantProfile.mobile_no || '—' }}</span>
                    </div>
                ...
                <div class="detail-section" v-if="merchantProfile.lat">
                  ...
                  <div class="location-chip-row">
                    <div class="location-chip"><span class="mdi mdi-latitude"></span> Lat: {{ merchantProfile.lat }}</div>
                    <div class="location-chip"><span class="mdi mdi-longitude"></span> Long: {{ merchantProfile.long }}</div>
                  </div>
                </div>
                ...
                <label class="confirm-check-wrap">
                  ...
                  <span class="confirm-text">I have reviewed all the above details and confirm they are correct. Clicking <strong>Confirm &amp; Send OTP</strong> will send a one-time password to the registered mobile number to proceed with ISG verification.</span>
                </label>
              </template>
            ...
            <div class="card-body">
                ...
                <div class="form-field-wrap">
                  ...
                  <div class="form-input-box">
                    ...
                    <input
                      ...
                      maxlength="6"
                      inputmode="numeric"
                      style="letter-spacing: 0.3em; font-size: 18px; font-weight: 700;"
                    />
                  </div>
                </div>
              </div>
              ...
              <div style="margin-top:12px; font-size:13px; color:#64748b;">
                ...
                <span
                  ...
                  style="color:#0a3d4a; font-weight:700; cursor:pointer; margin-left:4px;"
                  @click="resendOtp"
                >Resend OTP</span>
          ...
          <template v-else-if="step === 3">
            <div class="card-body">
              ...
              <p class="card-desc">Enter PAN details to verify the merchant's identity with ISG. This must match government records exactly.</p>
              ...
              <div v-if="!panVerified" class="form-grid" style="max-width:420px; width:100%;">
                <div class="form-field-wrap">
                  ...
                  <div class="form-input-box" :class="{ 'form-input-box--error': panErrors.pan }">
                    ...
                    <input v-model="panData.pan" class="form-input" placeholder="ABCDE1234F" maxlength="10" style="text-transform:uppercase" @input="panData.pan = panData.pan.toUpperCase(); panErrors.pan = ''" />
                  </div>
                ...
                <div class="form-field-wrap">
                  ...
                  <div class="form-input-box" :class="{ 'form-input-box--error': panErrors.name }">
                    ...
                    <input v-model="panData.name" class="form-input" placeholder="Full name as on PAN" @input="panErrors.name = ''" />
                  </div>
                ...
                <div class="form-field-wrap">
                  ...
                  <div class="form-input-box" :class="{ 'form-input-box--error': panErrors.fathername }">
                    ...
                    <input v-model="panData.fathername" class="form-input" placeholder="Father's name" @input="panErrors.fathername = ''" />
                  </div>
          ...
          <template v-else-if="step === 4">
            <div class="card-body">
              ...
              <div v-if="!accountVerified" class="form-grid" style="max-width:420px; width:100%;">
                <div class="form-field-wrap">
                  ...
                  <div class="form-input-box" :class="{ 'form-input-box--error': accountErrors.accountHolderName }">
                    <span class="mdi mdi-account-outline form-icon"></span>
                    <input v-model="accountData.accountHolderName" class="form-input" placeholder="Full name" @input="accountErrors.accountHolderName = ''" />
                  </div>
                ...
                <div class="form-field-wrap">
                  ...
                  <div class="form-input-box" :class="{ 'form-input-box--error': accountErrors.accountNumber }">
                    ...
                    <input v-model="accountData.accountNumber" class="form-input" placeholder="Bank account number" inputmode="numeric" @input="accountErrors.accountNumber = ''" />
                  </div>
                ...
                <div class="form-field-wrap">
                  ...
                  <div class="form-input-box" :class="{ 'form-input-box--error': accountErrors.ifsc }">
                    ...
                    <input v-model="accountData.ifsc" class="form-input" placeholder="SBIN0001234" maxlength="11" style="text-transform:uppercase" @input="accountData.ifsc = accountData.ifsc.toUpperCase(); accountErrors.ifsc = ''" />
                  </div>
                  <span v-if="accountErrors.ifsc" class="field-error">{{ accountErrors.ifsc }}</span>
                </div>
              </div>

              <div v-if="accountVerified && accountSummary" class="account-summary-card" style="max-width:420px; margin-top:16px;">
                <div class="summary-row"><span class="summary-key">Bank</span><span class="summary-val">{{ accountSummary.bank_name }}</span></div>
                <div class="summary-row"><span class="summary-key">Branch</span><span class="summary-val">{{ accountSummary.branch_name }}</span></div>
                <div class="summary-row"><span class="summary-key">IFSC</span><span class="summary-val">{{ accountSummary.bank_ifsc_code }}</span></div>
              ...
              <div class="info-hint-box" style="max-width:420px; margin-top:16px;">
                <span class="mdi mdi-information-outline"></span>
                <p>The bank account provided will be used as the settlement account. Ensure the account holder name matches the PAN name for successful verification.</p>
              </div>
            </div>
          </template>
            ...
            <div class="card-body step1-body">
              ...
              <template v-else>
                <div style="margin-bottom:20px;">
                  ...
                  <p class="verify-biz" style="margin-top:4px;">Upload the required documents to complete verification</p>
                </div>
                  ...
                  <div class="doc-category-grid">
                    ...
                    >
                      <div class="doc-cat-header">
                        <div class="doc-cat-icon" :class="group.compliant ? 'doc-cat-icon--done' : 'doc-cat-icon--pending'">
                          <span class="mdi" :class="group.compliant ? 'mdi-check-circle' : 'mdi-file-upload-outline'"></span>
                        </div>
                        <div class="doc-cat-chip" :class="group.compliant ? 'doc-cat-chip--done' : 'doc-cat-chip--pending'">
                  ...
                  <div class="doc-category-grid">
                    ...
                    >
                      <div class="doc-item-status-icon">
                        <span class="mdi" :class="doc.uploaded ? 'mdi-check-circle-outline' : 'mdi-alert-circle-outline'" :style="{ color: doc.uploaded ? '#16a34a' : '#ef4444' }"></span>
                      </div>
                      <div class="doc-item-name">{{ doc.name }}</div>
                      <div class="doc-item-chip" :class="doc.uploaded ? 'doc-item-chip--done' : 'doc-item-chip--pending'">
                ...
                <template v-else-if="docStep === 2">
                  ...
                  <div class="doc-upload-form">
                    ...
                    <div v-if="showDocNumber && activeDocType !== 'BANK_PASSBOOK'" class="form-field-wrap" style="max-width:420px; width:100%;">
                      <label class="form-label">{{ docNumberLabel }} <span class="req-star">*</span></label>
                      <div class="form-input-box">
                        <span class="mdi mdi-identifier form-icon"></span>
                        <input v-model="docUploads[activeDocType].docNumber" class="form-input" :placeholder="docNumberLabel" />
                      </div>
                    </div>

                    <!-- BANK PASSBOOK FIELDS -->
                    <div v-if="activeDocType === 'BANK_PASSBOOK'" class="form-grid" style="max-width:420px; width:100%;">
                      <div class="form-field-wrap">
                        <label class="form-label">ACCOUNT HOLDER NAME <span class="req-star">*</span></label>
                        <div class="form-input-box"><span class="mdi mdi-account-outline form-icon"></span><input v-model="docUploads.BANK_PASSBOOK.settlement.accountHolderName" class="form-input" placeholder="Account holder name" /></div>
                      </div>
                      <div class="form-field-wrap">
                        <label class="form-label">ACCOUNT NUMBER <span class="req-star">*</span></label>
                        <div class="form-input-box"><span class="mdi mdi-bank-outline form-icon"></span><input v-model="docUploads.BANK_PASSBOOK.settlement.accountNumber" class="form-input" placeholder="Account number" inputmode="numeric" /></div>
                      </div>
                      <div class="form-field-wrap">
                        <label class="form-label">BANK NAME <span class="req-star">*</span></label>
                        <div class="form-input-box"><span class="mdi mdi-bank form-icon"></span><input v-model="docUploads.BANK_PASSBOOK.settlement.bankName" class="form-input" placeholder="Bank name" /></div>
                      </div>
                      <div class="form-field-wrap">
                        <label class="form-label">IFSC CODE <span class="req-star">*</span></label>
                        <div class="form-input-box"><span class="mdi mdi-bank-transfer form-icon"></span><input v-model="docUploads.BANK_PASSBOOK.settlement.ifsc" class="form-input" placeholder="SBIN0001234" maxlength="11" style="text-transform:uppercase" @input="docUploads.BANK_PASSBOOK.settlement.ifsc = docUploads.BANK_PASSBOOK.settlement.ifsc.toUpperCase()" /></div>
                      </div>
                      <div class="form-field-wrap">
                        <label class="form-label">CITY <span class="req-star">*</span></label>
                        <div class="form-input-box"><span class="mdi mdi-city-variant-outline form-icon"></span><input v-model="docUploads.BANK_PASSBOOK.settlement.city" class="form-input" placeholder="City" /></div>
                      </div>
                      <div class="form-field-wrap">
                        <label class="form-label">STATE <span class="req-star">*</span></label>
                        <div class="form-input-box"><span class="mdi mdi-map-outline form-icon"></span><input v-model="docUploads.BANK_PASSBOOK.settlement.state" class="form-input" placeholder="State" /></div>
                      </div>
                      <div class="form-field-wrap">
                        <label class="form-label">ACCOUNT TYPE <span class="req-star">*</span></label>
                        <div class="form-input-box">
                          <span class="mdi mdi-wallet-outline form-icon"></span>
                          <select v-model="docUploads.BANK_PASSBOOK.settlement.account_type" class="form-input" style="cursor:pointer;">
                    ...
                    <!-- PAN FIELDS -->
                    <div v-if="activeDocType === 'INDIVIDUAL_PAN' || activeDocType === 'PARTNER1_INDIVIDUAL_PAN' || activeDocType === 'PARTNER2_INDIVIDUAL_PAN'" class="form-grid" style="max-width:420px; width:100%;">
                      <div class="form-field-wrap">
                        <label class="form-label">PAN NUMBER <span class="req-star">*</span></label>
                        <div class="form-input-box"><span class="mdi mdi-card-account-details-outline form-icon"></span><input v-model="docUploads[activeDocType].pan.pan" class="form-input" placeholder="ABCDE1234F" maxlength="10" style="text-transform:uppercase" @input="docUploads[activeDocType].pan.pan = docUploads[activeDocType].pan.pan.toUpperCase()" /></div>
                      </div>
                      <div class="form-field-wrap">
                        <label class="form-label">PAN HOLDER NAME <span class="req-star">*</span></label>
                        <div class="form-input-box"><span class="mdi mdi-account-outline form-icon"></span><input v-model="docUploads[activeDocType].pan.pan_name" class="form-input" placeholder="Full name as on PAN" /></div>
                      </div>
                      <div class="form-field-wrap">
                        <label class="form-label">FATHER'S NAME <span class="req-star">*</span></label>
                        <div class="form-input-box"><span class="mdi mdi-account-child-outline form-icon"></span><input v-model="docUploads[activeDocType].pan.pan_father_name" class="form-input" placeholder="Father's name" /></div>
                      </div>
                      <div class="form-field-wrap">
                        <label class="form-label">DATE OF BIRTH <span class="req-star">*</span></label>
                        <div class="form-input-box"><span class="mdi mdi-calendar-outline form-icon"></span><input v-model="docUploads[activeDocType].pan.pan_dob" class="form-input" type="date" /></div>
                      </div>
                    </div>

                    <!-- File Upload -->
                    <div class="file-upload-area" style="max-width:420px; width:100%; margin-top:16px;">
                      <label class="form-label">UPLOAD {{ requiredImageCount }} IMAGE(S) <span class="req-star">*</span></label>
                    ...
                    <button
                      ...
                      @click="saveDocUpload"
                      style="max-width:420px; width:100%; margin-top:20px;"
                    >
          ...
          <template v-else-if="step === 6">
            <div class="card-body step1-body">
              <div style="margin-bottom:20px;">
                ...
                <p class="verify-biz" style="margin-top:4px;">All verifications complete. Review your verified details and submit to ISG.</p>
              </div>

              <div class="verification-status-grid">
                <div class="vstatus-card" :class="otpVerified ? 'vstatus-card--done' : 'vstatus-card--pending'">
                  <div class="vstatus-icon-wrap"><span class="mdi" :class="otpVerified ? 'mdi-check-circle' : 'mdi-alert-circle-outline'"></span></div>
                  <div class="vstatus-info">
                    <p class="vstatus-title">Mobile Verified</p>
                    <p class="vstatus-sub">{{ otpVerified ? otpPhone : 'Not verified' }}</p>
                  </div>
                  <span class="vstatus-badge" :class="otpVerified ? 'vstatus-badge--done' : 'vstatus-badge--pending'">{{ otpVerified ? 'Verified' : 'Pending' }}</span>
                </div>

                <div class="vstatus-card" :class="panVerified ? 'vstatus-card--done' : 'vstatus-card--pending'">
                  <div class="vstatus-icon-wrap"><span class="mdi" :class="panVerified ? 'mdi-check-circle' : 'mdi-alert-circle-outline'"></span></div>
                  <div class="vstatus-info">
                    <p class="vstatus-title">PAN Verification</p>
                    <p class="vstatus-sub">{{ panVerified ? (panVerifiedName || panData.pan) : 'Not verified' }}</p>
                  </div>
                  <span class="vstatus-badge" :class="panVerified ? 'vstatus-badge--done' : 'vstatus-badge--pending'">{{ panVerified ? 'Verified' : 'Pending' }}</span>
                </div>

                <div class="vstatus-card" :class="accountVerified ? 'vstatus-card--done' : 'vstatus-card--pending'">
                  <div class="vstatus-icon-wrap"><span class="mdi" :class="accountVerified ? 'mdi-check-circle' : 'mdi-alert-circle-outline'"></span></div>
                  <div class="vstatus-info">
                    <p class="vstatus-title">Bank Account</p>
                    <p class="vstatus-sub">{{ accountVerified ? (accountSummary?.bank_name || accountData.accountNumber) : 'Not verified' }}</p>
                  </div>
                  <span class="vstatus-badge" :class="accountVerified ? 'vstatus-badge--done' : 'vstatus-badge--pending'">{{ accountVerified ? 'Verified' : 'Pending' }}</span>
                </div>

                <div class="vstatus-card" :class="isComplianceComplete ? 'vstatus-card--done' : 'vstatus-card--pending'">
                  <div class="vstatus-icon-wrap"><span class="mdi" :class="isComplianceComplete ? 'mdi-check-circle' : 'mdi-alert-circle-outline'"></span></div>
                  <div class="vstatus-info">
                    <p class="vstatus-title">Documents</p>
                    <p class="vstatus-sub">{{ isComplianceComplete ? 'All documents uploaded' : 'Some documents missing' }}</p>
                  </div>
                  <span class="vstatus-badge" :class="isComplianceComplete ? 'vstatus-badge--done' : 'vstatus-badge--pending'">{{ isComplianceComplete ? 'Complete' : 'Pending' }}</span>
                </div>
              </div>

              <div v-if="!panVerified || !accountVerified || !isComplianceComplete" class="warn-alert" style="margin-top:16px;">
                <span class="mdi mdi-alert-outline warn-alert__icon"></span>
                <p>
              ...
              <div v-if="panVerified && accountVerified && isComplianceComplete" class="success-alert" style="margin-top:16px;">
                <span class="mdi mdi-check-circle-outline success-alert__icon"></span>
          ...
          <template v-else-if="step === 7">
            <div class="card-body">
              ...
              <p class="card-desc">Your ISG onboarding has been successfully submitted. Terminal activation will be completed shortly.</p>
              ...
              <div v-if="submitResult" class="result-chips">
                <div v-if="submitResult.tid" class="result-chip">
                  ...
                  <div><p class="result-chip__label">Terminal ID</p><p class="result-chip__val">{{ submitResult.tid }}</p></div>
                </div>
                <div v-if="submitResult.vpa" class="result-chip">
                  <span class="mdi mdi-qrcode result-chip__icon"></span>
                  <div><p class="result-chip__label">VPA</p><p class="result-chip__val">{{ submitResult.vpa }}</p></div>
                </div>
                <div v-if="submitResult.appID" class="result-chip">
                  <span class="mdi mdi-application-outline result-chip__icon"></span>
                  <div><p class="result-chip__label">App ID</p><p class="result-chip__val">{{ submitResult.appID }}</p></div>
                </div>
              </div>
          ...
          <div class="card-footer" v-if="step !== 7">
            ...
            <div class="footer-right-btns">
              ...
              <button v-if="step === 1" class="btn-continue" :disabled="loading || fetchingMerchant || !detailsConfirmed || !merchantProfile" @click="handleStep1Confirm">
                <span v-if="loading" class="spinner-btn"></span>
                <template v-else>Confirm &amp; Send OTP <span class="mdi mdi-send"></span></template>
              </button>

              <!-- Step 2: Verify OTP -->
              <button v-else-if="step === 2" class="btn-continue" :disabled="loading || !otpCode || otpCode.length < 4" @click="handleStep2VerifyOtp">
                <span v-if="loading" class="spinner-btn"></span>
              ...
              <button v-else-if="step === 3" class="btn-continue" :disabled="loading" @click="handleStep3Pan">
                <span v-if="loading" class="spinner-btn"></span>
                <template v-else>{{ panVerified ? 'Continue' : 'Verify PAN' }} <span class="mdi mdi-arrow-right"></span></template>
              </button>

              <!-- Step 4: Verify Account -->
              <button v-else-if="step === 4" class="btn-continue" :disabled="loading" @click="handleStep4Account">
                <span v-if="loading" class="spinner-btn"></span>
                <template v-else>{{ accountVerified ? 'Continue' : 'Verify Account' }} <span class="mdi mdi-arrow-right"></span></template>
              </button>

              <!-- Step 5: Documents -->
              <button v-else-if="step === 5" class="btn-continue" :disabled="!isComplianceComplete || fetchingCompliance" @click="handleStep5Docs">
                {{ isComplianceComplete ? 'Continue' : 'Upload Documents' }}
                <span class="mdi mdi-arrow-right"></span>
              </button>

              <!-- Step 6: Submit -->
              <button v-else-if="step === 6" class="btn-continue" :disabled="!panVerified || !accountVerified || !isComplianceComplete || submitting" @click="handleStep6Submit">
        ...
        <div class="info-cards">
          <div class="info-card">
            ...
            <div>
              ...
              <p class="info-desc">Review all merchant details first. OTP will be auto-sent to the registered mobile number.</p>
            </div>
          </div>
          <div class="info-card">
...
const DOC_RULES = {
  ...
  PARTNER1_AADHAAR: { label: "Aadhaar Number", images: 2, requiresNumber: true,
    buildPayload: (doc, imageIds) => ({ doc_type: "PARTNER1_AADHAAR", partner: 1, doc_number: doc.docNumber, images: imageIds }) },
  PARTNER2_AADHAAR: { label: "Aadhaar Number", images: 2, requiresNumber: true,
  ...
  PARTNER1_DRIVING_LICENSE: { label: "Driving License Number", images: 1, requiresNumber: true,
    buildPayload: (doc, imageIds) => ({ doc_type: "PARTNER1_DRIVING_LICENSE", partner: 1, doc_number: doc.docNumber, images: imageIds }) },
  PARTNER2_DRIVING_LICENSE: { label: "Driving License Number", images: 1, requiresNumber: true,
  ...
  PARTNER1_VOTER_ID: { label: "Voter ID Number", images: 1, requiresNumber: true,
    buildPayload: (doc, imageIds) => ({ doc_type: "PARTNER1_VOTER_ID", partner: 1, doc_number: doc.docNumber, images: imageIds }) },
  PARTNER2_VOTER_ID: { label: "Voter ID Number", images: 1, requiresNumber: true,
  ...
  PARTNER1_PASSPORT: { label: "Passport Number", images: 1, requiresNumber: true,
    buildPayload: (doc, imageIds) => ({ doc_type: "PARTNER1_PASSPORT", partner: 1, doc_number: doc.docNumber, images: imageIds }) },
  PARTNER2_PASSPORT: { label: "Passport Number", images: 1, requiresNumber: true,
  ...
  INDOOR_STORE_IMAGE: { label: null, images: 1, requiresNumber: false,
    buildPayload: (doc, imageIds) => ({ doc_type: "INDOOR_STORE_IMAGE", doc_number: doc.docNumber, images: imageIds }) },
  OUTDOOR_STORE_IMAGE: { label: null, images: 1, requiresNumber: false,
...
const requiredDocs = computed(() => {
  ...
  return complianceResponse.value.categories.map(cat => {
    ...
    const missing    = isStoreImage ? Math.max(cat.documents.length - uploadedCount, 0) : compliant ? 0 : 1;
    return { category: cat.category, documents: cat.documents, required, uploaded, missing, compliant };
  });
});
...
async function handleStep4Account() {
  if (accountVerified.value) { await loadComplianceAndProceed(); return; }
...
.isg-root { font-family: 'Inter', sans-serif; background: #f6f6f8; min-height: 100vh; display: flex; flex-direction: column; }

/* Header */
.isg-header { display: flex; align-items: center; justify-content: space-between; background: #0a3d4a; border-bottom: 1px solid rgba(255,255,255,0.1); padding: 14px 24px; position: sticky; top: 0; z-index: 50; }
@media (min-width: 768px) { .isg-header { padding: 14px 40px; } }
...
/* Main */
.isg-main { flex: 1; display: flex; flex-direction: column; align-items: center; padding: 24px 16px 40px; }
...
.active-badge { font-size: 10px; font-weight: 700; color: #0a3d4a; background: rgba(10,61,74,0.08); padding: 4px 10px; border-radius: 9999px; white-space: nowrap; flex-shrink: 0; border: 1px solid rgba(10,61,74,0.15); }
...
.track-fill { position: absolute; top: 20px; left: 0; height: 4px; background: #0a3d4a; border-radius: 4px; z-index: 1; transition: width 0.5s ease; }
...
.step-active  { background: #0a3d4a; color: #fff; box-shadow: 0 4px 16px rgba(10,61,74,0.3); }
.step-done    { background: #0a3d4a; color: #fff; }
...
.step-label-active { color: #0a3d4a; font-weight: 700; }
...
/* Verify header */
.verify-header { display: flex; align-items: center; gap: 14px; background: linear-gradient(135deg,rgba(10,61,74,0.05),rgba(10,61,74,0.02)); border: 1px solid rgba(10,61,74,0.12); border-radius: 12px; padding: 16px; margin-bottom: 16px; }
.verify-avatar { width: 52px; height: 52px; border-radius: 14px; background: #0a3d4a; display: flex; align-items: center; justify-content: center; color: #fff; font-size: 24px; flex-shrink: 0; box-shadow: 0 4px 14px rgba(10,61,74,0.3); }
...
.verify-badge { display: inline-block; margin-top: 6px; font-size: 10px; font-weight: 700; letter-spacing: 0.06em; background: rgba(10,61,74,0.1); color: #0a3d4a; padding: 3px 10px; border-radius: 9999px; }
...
/* OTP highlight cell */
.otp-highlight-cell { border-color: rgba(10,61,74,0.3) !important; background: #f0f7f9 !important; }
.otp-will-use-tag { display: inline-block; margin-left: 6px; font-size: 9px; font-weight: 700; background: #0a3d4a; color: #fff; padding: 1px 6px; border-radius: 9999px; vertical-align: middle; text-transform: uppercase; letter-spacing: 0.05em; }

/* Detail sections */
.detail-section { margin-bottom: 20px; }
.section-label-row { display: flex; align-items: center; gap: 7px; margin-bottom: 10px; }
.section-icon { font-size: 15px; color: #0a3d4a; }
.section-label { font-size: 11px; font-weight: 800; text-transform: uppercase; letter-spacing: 0.08em; color: #0a3d4a; }
...
.location-chip { display: flex; align-items: center; gap: 6px; background: #f0f7f9; border: 1px solid rgba(10,61,74,0.15); border-radius: 8px; padding: 8px 14px; font-size: 12px; font-weight: 700; color: #0a3d4a; }
.confirm-check-wrap { display: flex; align-items: flex-start; gap: 10px; background: #f0f7f9; border: 1.5px solid rgba(10,61,74,0.2); border-radius: 10px; padding: 14px 16px; cursor: pointer; margin-top: 8px; }
.confirm-checkbox { width: 16px; height: 16px; accent-color: #0a3d4a; flex-shrink: 0; margin-top: 2px; cursor: pointer; }
.confirm-text { font-size: 13px; font-weight: 500; color: #0e3a45; line-height: 1.5; }
...
.error-icon-ring { width: 80px; height: 80px; border-radius: 50%; display: flex; align-items: center; justify-content: center; position: relative; z-index: 1; }
...
.illustration-circle { aspect-ratio: 1; background: linear-gradient(135deg,rgba(10,61,74,0.05),rgba(10,61,74,0.15)); border-radius: 50%; display: flex; align-items: center; justify-content: center; }
...
.upload-icon { font-size: 44px; color: #0a3d4a; display: block; }
.analyzing-text { font-size: 8px; font-weight: 700; color: #0a3d4a; letter-spacing: 0.12em; text-transform: uppercase; }
...
/* Verified banner */
.verified-banner { display: flex; align-items: center; gap: 12px; background: #eefaf3; border: 1.5px solid #a7e0bc; border-radius: 10px; padding: 14px 18px; max-width: 420px; width: 100%; margin-top: 16px; text-align: left; }
...
.compliance-spinner { width: 36px; height: 36px; border: 3px solid #e8f0f7; border-top-color: #0a3d4a; border-radius: 50%; animation: spin 0.8s linear infinite; }
...
.doc-category-card { display: flex; flex-direction: column; gap: 10px; padding: 16px; border-radius: 12px; border: 1.5px solid #e2e8f0; background: #f8fafc; cursor: pointer; transition: transform 0.15s, border-color 0.15s, box-shadow 0.15s; }
...
.doc-back-btn { width: 36px; height: 36px; border-radius: 10px; border: 1px solid #e2e8f0; background: #f8fafc; display: flex; align-items: center; justify-content: center; cursor: pointer; font-size: 16px; color: #475569; transition: background 0.15s; flex-shrink: 0; }
.doc-back-btn:hover { background: #e2e8f0; color: #0a3d4a; }
...
.doc-item-card { display: flex; flex-direction: column; align-items: center; gap: 8px; padding: 16px 12px; border-radius: 10px; border: 1.5px solid #e2e8f0; background: #f8fafc; text-align: center; }
...
.doc-item-btn { width: 100%; padding: 8px 12px; font-size: 11px; font-weight: 700; border-radius: 7px; border: 1px solid #e2e8f0; background: #fff; color: #0a3d4a; cursor: pointer; margin-top: 4px; transition: background 0.15s; }
.doc-item-btn:hover:not(:disabled) { background: #f0f7f9; }
...
.file-drop-zone { border: 2px dashed #c5d8e8; border-radius: 10px; padding: 24px 16px; display: flex; flex-direction: column; align-items: center; gap: 8px; text-align: center; cursor: pointer; background: #f0f7f9; transition: border-color 0.15s, background 0.15s; }
.file-drop-zone:hover { border-color: #0a3d4a; background: #e8f2f7; }
.file-drop-icon { font-size: 32px; color: #0a3d4a; }
.file-drop-text { font-size: 13px; font-weight: 600; color: #0a3d4a; }
...
.file-chip { display: flex; align-items: center; gap: 8px; background: #eefaf3; border: 1px solid #a7e0bc; border-radius: 7px; padding: 7px 12px; font-size: 12px; font-weight: 500; color: #145b32; }
.file-chip-name { overflow: hidden; text-overflow: ellipsis; white-space: nowrap; }
.btn-save-doc { display: flex; align-items: center; justify-content: center; gap: 6px; padding: 12px 24px; font-size: 13px; font-weight: 700; color: #fff; background: #0a3d4a; border: none; border-radius: 8px; cursor: pointer; box-shadow: 0 4px 14px rgba(10,61,74,0.28); transition: filter 0.15s, opacity 0.15s; font-family: inherit; }
.btn-save-doc:hover:not(:disabled) { filter: brightness(1.1); }
.btn-save-doc:disabled { opacity: 0.45; cursor: not-allowed; }

/* Verification status grid */
.verification-status-grid { display: flex; flex-direction: column; gap: 12px; width: 100%; }
.vstatus-card { display: flex; align-items: center; gap: 12px; padding: 14px 16px; border-radius: 10px; border: 1.5px solid #e2e8f0; background: #f8fafc; }
.vstatus-card--done    { border-color: rgba(34,197,94,0.35); background: #eefaf3; }
.vstatus-card--pending { border-color: #fbd89d; background: #fff8ee; }
.vstatus-icon-wrap { width: 36px; height: 36px; border-radius: 10px; display: flex; align-items: center; justify-content: center; flex-shrink: 0; }
.vstatus-card--done    .vstatus-icon-wrap { background: rgba(34,197,94,0.15); color: #22c55e; font-size: 20px; }
.vstatus-card--pending .vstatus-icon-wrap { background: rgba(245,158,11,0.12); color: #f59e0b; font-size: 20px; }
.vstatus-info { flex: 1; min-width: 0; }
.vstatus-title { font-size: 13px; font-weight: 700; color: #0f172a; }
.vstatus-sub   { font-size: 11px; color: #64748b; margin-top: 2px; }
.vstatus-badge { font-size: 10px; font-weight: 700; padding: 3px 10px; border-radius: 9999px; white-space: nowrap; }
.vstatus-badge--done    { background: rgba(34,197,94,0.15); color: #15803d; }
.vstatus-badge--pending { background: rgba(245,158,11,0.12); color: #b45309; }

/* Result chips */
.result-chips { display: flex; gap: 10px; flex-wrap: wrap; justify-content: center; margin-top: 20px; margin-bottom: 8px; }
.result-chip { display: flex; align-items: center; gap: 10px; background: #f0f7f9; border: 1px solid rgba(10,61,74,0.15); border-radius: 10px; padding: 10px 16px; min-width: 160px; }
.result-chip__icon { font-size: 22px; color: #0a3d4a; flex-shrink: 0; }
.result-chip__label { font-size: 10px; font-weight: 700; color: #64748b; text-transform: uppercase; }
.result-chip__val   { font-size: 13px; font-weight: 700; color: #0a3d4a; margin-top: 2px; word-break: break-all; }
...
.form-input-box:focus-within { border-color: #0a3d4a; box-shadow: 0 0 0 3px rgba(10,61,74,0.1); background: #fff; }
...
.form-input-box:focus-within .form-icon { color: #0a3d4a; }
...
.info-hint-box .mdi { font-size: 14px; color: #0a3d4a; flex-shrink: 0; margin-top: 1px; }

/* Alerts */
.warn-alert { display: flex; align-items: flex-start; gap: 8px; background: #fff8ee; border: 1px solid #fbd89d; border-radius: 8px; padding: 10px 14px; font-size: 13px; color: #7a4800; line-height: 1.5; }
.warn-alert__icon { font-size: 15px; color: #d97706; flex-shrink: 0; margin-top: 1px; }
.success-alert { display: flex; align-items: flex-start; gap: 8px; background: #eefaf3; border: 1px solid #a7e0bc; border-radius: 8px; padding: 10px 14px; font-size: 13px; color: #145b32; line-height: 1.5; }
...
/* Card footer */
.card-footer { background: #f8fafc; border-top: 1px solid #e2e8f0; padding: 18px 24px; display: flex; flex-direction: row; align-items: center; justify-content: space-between; gap: 12px; }
@media (max-width: 639px) { .card-footer { flex-wrap: wrap; padding: 16px; } }
.btn-back { display: flex; align-items: center; gap: 6px; padding: 10px 20px; font-size: 13px; font-weight: 600; color: #475569; background: none; border: none; border-radius: 8px; cursor: pointer; transition: background 0.15s; font-family: inherit; }
.btn-back:hover { background: #f1f5f9; color: #0a3d4a; }
.footer-right-btns { display: flex; gap: 10px; align-items: center; flex-wrap: wrap; justify-content: flex-end; }
.btn-continue { display: flex; align-items: center; justify-content: center; gap: 6px; padding: 10px 28px; font-size: 13px; font-weight: 700; color: #fff; background: #0a3d4a; border: none; border-radius: 8px; cursor: pointer; box-shadow: 0 4px 14px rgba(10,61,74,0.28); transition: filter 0.15s, opacity 0.15s; font-family: inherit; white-space: nowrap; }
...
.info-icon-wrap { padding: 8px; background: rgba(10,61,74,0.08); border-radius: 8px; color: #0a3d4a; flex-shrink: 0; }
...
/* Page footer */
.isg-footer { padding: 24px; text-align: center; font-size: 11px; color: #94a3b8; }
.footer-link { color: #94a3b8; text-decoration: underline; }
.footer-link:hover { color: #0a3d4a; }
...
.snackbar-success { background: #0a3d4a; }
...
/* Processing overlay */
.processing-overlay { position: fixed; inset: 0; background: rgba(0,22,30,0.5); backdrop-filter: blur(4px); display: flex; align-items: center; justify-content: center; z-index: 9998; }
...
.processing-spinner { width: 44px; height: 44px; border: 3px solid #e8f0f7; border-top-color: #0a3d4a; border-radius: 50%; animation: spin 0.8s linear infinite; margin: 0 auto 20px; }
.processing-title { font-size: 15px; font-weight: 700; color: #0a3d4a; }
