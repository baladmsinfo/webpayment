  ...
  <div class="page-root">
    ...
    <div class="page-header">
      <div>
        ...
        <p class="page-sub">{{ vendor?.name || 'Manage your account preferences' }}</p>
      </div>
      <div class="vendor-status-badge" v-if="vendor">
    ...
    <div class="tab-nav">
      <button
        class="tab-btn"
        :class="{ 'tab-btn-active': tab === 'vendor' }"
        @click="tab = 'vendor'"
      >
        <span class="mdi mdi-account-cog-outline tab-icon"></span>
        Vendor Info
      </button>
      <button
        class="tab-btn"
        :class="{ 'tab-btn-active': tab === 'reset' }"
        @click="tab = 'reset'"
      >
    ...
    <!-- VENDOR INFO TAB -->
    <div v-if="tab === 'vendor'" class="tab-pane">
      <div class="settings-grid">
        ...
        <div class="profile-card">
          <template v-if="vendor">
            <div class="profile-avatar-wrap">
              <div class="profile-avatar">{{ initials(vendor.name) }}</div>
        ...
        <div class="info-card">
            ...
            <div class="info-rows">
              <div class="info-row">
                <div class="info-row-left">
                  ...
                  <span class="info-row-label">Vendor Code</span>
                </div>
                <div class="info-row-value">
                  <span class="mono-val">{{ vendor.code }}</span>
                  <button class="copy-btn" @click="copy(vendor.code)" :title="'Copy ' + vendor.code">
                    <span class="mdi" :class="copied === vendor.code ? 'mdi-check' : 'mdi-content-copy'"></span>
                  </button>
                </div>
              </div>
              ...
              <div class="info-row">
                <div class="info-row-left">
                  ...
                  <span class="info-row-label">Vendor ID</span>
                </div>
                <div class="info-row-value">
                  <span class="mono-val mono-val-truncate">{{ vendor.id }}</span>
                  <button class="copy-btn" @click="copy(vendor.id)" :title="'Copy ID'">
                    <span class="mdi" :class="copied === vendor.id ? 'mdi-check' : 'mdi-content-copy'"></span>
                  </button>
                </div>
              </div>
              ...
              <div class="info-row">
                ...
                <span class="info-row-value info-row-value-plain">{{ vendor.name }}</span>
              </div>
              ...
              <div class="info-row">
                ...
                <div class="info-row-value">
                  <span class="info-text">{{ vendor.email }}</span>
                  <button class="copy-btn" @click="copy(vendor.email)">
                    <span class="mdi" :class="copied === vendor.email ? 'mdi-check' : 'mdi-content-copy'"></span>
                  </button>
                </div>
              </div>
              ...
              <div class="info-row" style="border-bottom: none;">
                ...
                <span class="info-row-value info-row-value-plain">{{ vendor.mobile }}</span>
              </div>
            </div>
          </template>
          ...
          <template v-else>
            <div class="info-rows">
              <div class="info-row" v-for="i in 5" :key="i" :style="i === 5 ? 'border-bottom:none' : ''">
        ...
        <div class="reset-card">
          ...
          <transition name="t-alert">
            <div v-if="showAlert" class="alert-box" :class="alertType === 'success' ? 'alert-success' : 'alert-error'">
              <span class="mdi" :class="alertType === 'success' ? 'mdi-check-circle-outline' : 'mdi-alert-circle-outline'"></span>
          ...
          <div class="reset-form">
            ...
            <div class="form-field">
              ...
              <div class="password-wrap" :class="{ focused: focuses.confirm, 'pw-error': confirmPassword && newPassword !== confirmPassword }">
...
.tab-btn-active {
  background: #fff !important; color: #1142d4 !important;
...
@media (min-width: 768px) {
  .reset-outer { grid-template-columns: 1fr 280px; }
}
...
.str-weak   .strength-fill, .str-weak   { background: #ef4444; color: #ef4444; }
.str-fair   .strength-fill, .str-fair   { background: #f59e0b; color: #f59e0b; }
.str-good   .strength-fill, .str-good   { background: #3b82f6; color: #3b82f6; }
.str-strong .strength-fill, .str-strong { background: #22c55e; color: #22c55e; }
