...
// Form state
const form = reactive({
  legal_name: "V Nandhagopi",
  business_name: "Nandhu Furnitures",
  dba_name: "Nandhu Furnitures",
  dob: "1998-07-15",
  primary_email_id: "nandhagopiv@gmail.com",
  primary_mobile: "6382372062",
  business_type: "INDIVIDUAL",
  nature_of_business: "Furniture Stores",
  annual_turn_over: "10-25 Lacs",
  gender: "M",

  lat: "10.3673",
  long: "77.9803",

  website: "https://www.nandhufurnitures.com",

  beneficiary_email: "accounts@nandhufurnitures.com",
  beneficiary_mobile: "6382372062",

  official_address: "12/7, Gandhi Nagar",
  address1: "Main Road",
  address2: "Near Bus Stand",
  address3: "Opposite Indian Bank",
  phone: "04512456789",
  city: "DINDIGUL",
  state: "TAMIL NADU",
  pincode: "624003",

  residential_address: "12/7, Gandhi Nagar",
  res_address1: "Main Road",
  res_address2: "Near Bus Stand",
  res_address3: "",
  res_mobile: "6382372062",
  res_phone_number: "",
  res_city: "DINDIGUL",
  res_state: "TAMIL NADU",
  res_pincode: "624003",

  vister_address: "Nandhu Furnitures Showroom",
  v_address1: "Market Street",
  v_address2: "Near Clock Tower",
  v_address3: "",
  v_mobile: "6382372062",
  v_phone_number: "",
  v_city: "DINDIGUL",
  ...
  mcc: "5712", // Furniture Stores MCC code
...
async function submitMerchant() {
    ...
    if (mcc) {
        form.mcc = mcc.id
        form.nature_of_business = mcc.descr
    }
