      ...
      <section v-show="activeTab === 'commissions'" class="tab-section">
        ...
        <div class="card">
          <div class="card__head">
            ...
            <span class="ml-auto"><span class="pill pill--indigo pill--sm">{{ vendorForm.commissions?.length || 0 }} slabs</span></span>
          </div>
          <div class="table-scroll-wrap" v-if="vendorForm.commissions?.length">
            <table class="data-table">
              <thead><tr><th>Method</th><th>Provider</th><th>Txn Type</th><th>Min ₹</th><th>Max ₹</th><th>Rate</th><th>Rate Type</th></tr></thead>
              <tbody>
          ...
          <div class="empty-state" v-else><p>No vendor commissions configured</p></div>
        </div>

        <div class="card" v-if="vendorForm.aggregator?.commissions?.length">
          <div class="card__head">
            <div class="card__head-dot card__head-dot--amber"></div>
            <h3 class="card__title">Aggregator Commission Slabs</h3>
        ...
        <div class="card" v-if="vendorForm.aggregator?.bankcommissions?.length">
          <div class="card__head">
            <div class="card__head-dot card__head-dot--emerald"></div>
            <h3 class="card__title">Bank Commission Slabs</h3>
