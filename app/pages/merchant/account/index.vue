  ...
  <div class="history-page">
    ...
    <div class="page-header">
      <div class="page-title-wrap">
        <NuxtLink to="/merchant/dashboard" class="back-btn">
...
const handleExport = () => {
  ...
  a.href = url;
  a.download = `merchant-history-p${filters.page}.csv`;
  a.click();
...
.search-input {
  width: 100%; padding: 8px 30px 8px 32px; border: 1.5px solid #e2e8f0; border-radius: 9px;
  font-size: 13px; font-family: 'DM Sans', sans-serif; background: #f8fafc; outline: none; transition: border .2s;
}
...
.summary-chip {
  ...
  background: #fff; border: 1px solid #e8edf3; font-size: 12px;
}
...
.panel { background: #fff; border: 1px solid #e8edf3; border-radius: 16px; box-shadow: 0 1px 4px rgba(0,0,0,.04); overflow: hidden; }
...
.txn-row { border-bottom: 1px solid #f1f5f9; transition: background .1s; }
...
.type-dot { width: 26px; height: 26px; border-radius: 50%; display: flex; align-items: center; justify-content: center; font-size: 13px; flex-shrink: 0; }
...
.pag-btn {
  ...
  padding: 0 8px; font-family: 'DM Sans', sans-serif; transition: all .15s;
}
...
.pag-jump-input {
  width: 52px; padding: 6px 8px; border: 1.5px solid #e2e8f0; border-radius: 8px;
  font-size: 12px; font-family: 'DM Sans', sans-serif; text-align: center; outline: none; background: #fff;
}
.pag-jump-input:focus { border-color: #1142d4; }
.pag-jump-btn {
  padding: 6px 14px; border: none; border-radius: 8px; background: #1142d4; color: #fff;
  font-size: 12px; font-weight: 600; font-family: 'DM Sans', sans-serif; cursor: pointer; transition: background .15s;
}
.pag-jump-btn:hover { background: #0e35a8; }

.empty-state { display: flex; flex-direction: column; align-items: center; justify-content: center; gap: 10px; padding: 60px 20px; text-align: center; }
.empty-state p { font-size: 14px; color: #64748b; margin: 0; }
.empty-hint    { font-size: 12px; color: #94a3b8; }
.error-state   { color: #ba1a1a; }
.retry-btn { display: inline-flex; align-items: center; gap: 5px; padding: 9px 18px; border: none; border-radius: 9999px; background: #dc2626; color: #fff; font-size: 13px; font-weight: 600; font-family: 'DM Sans', sans-serif; cursor: pointer; }
.retry-btn:hover { background: #b91c1c; }

.skeleton-rows { padding: 8px 0; }
.skeleton-row { display: flex; align-items: center; gap: 16px; padding: 14px 20px; border-bottom: 1px solid #f1f5f9; }
.skeleton-row:last-child { border-bottom: none; }
.sk { background: linear-gradient(90deg, #f1f5f9 25%, #e8edf3 50%, #f1f5f9 75%); background-size: 200% 100%; border-radius: 6px; animation: shimmer 1.4s infinite; }
