...
// No charges preview here by design — the charge/GST breakdown is never
// shown before processing. store.fetchCharges() (and the debounced call
// to it that used to live here) is intentionally not used: the backend
// fetches NSDL's live charge itself when it actually processes the
// transfer, independent of anything this page does.
...
.amount-card { border: 1px solid #e6eaf1 !important; box-shadow: 0 1px 6px rgba(15,23,42,.05) !important; font-family: 'DM Sans', sans-serif; }
