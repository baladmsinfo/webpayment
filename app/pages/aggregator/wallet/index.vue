...
.btn-primary {
  ...
  font-size: .875rem; font-weight: 600; cursor: pointer; transition: background .17s;
}
...
.balance-card {
  ...
  overflow: hidden; min-height: 260px; color: #fff;
}
.balance-card-bg {
...
.live-dot {
  ...
  background: #4ade80; animation: pulse-g 1.8s infinite;
}
@keyframes pulse-g {
...
.balance-amount { display: flex; align-items: flex-end; gap: 6px; }
...
.bal-btn {
  ...
  font-size: .85rem; font-weight: 600; cursor: pointer; transition: background .17s;
}
...
.tab-btn {
  ...
  background: transparent; color: #6b7589; transition: background .15s, color .15s;
}
...
.search-input, .date-input {
  ...
  color: #0f1728; background: #fff; outline: none; transition: border-color .15s;
}
...
.icon-btn {
  ...
  font-size: 1rem; color: #6b7589; cursor: pointer; transition: border-color .15s, color .15s;
}
...
.hist-table th {
  ...
  letter-spacing: .04em; color: #8a93a8; border-bottom: 1px solid #f0f2f7;
}
.hist-table td {
...
.modal-header {
  ...
  padding: 20px 22px 16px; border-bottom: 1px solid #f0f2f7;
}
...
.modal-footer {
  padding: 14px 22px 20px; border-top: 1px solid #f0f2f7;
...
.amount-field {
  ...
  overflow: hidden; background: #f8f9fc; transition: border-color .15s;
}
...
.field-input.full {
  ...
  background: #f8f9fc; padding: 10px 14px; transition: border-color .15s;
}
